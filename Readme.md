...
# Parsing + Configuration Script – 1722 - Rev. A

This **Parsing + Configuration** script is designed for the **1722** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – 1722 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **1722** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
